...
| Hosted Windows CI | **All steps passed** for `a2e4e43` in [run 34301423262](https://github.com/moooyo/emby-client-winui3/actions/runs/34301423262) | Independent locked restore, Release build, 306 tests, AOT/SBOM output, unsigned MSIX construction, and artifact uploads; the new UI and network edits require another run |
...
- Resolve large-library memory behavior and complete native external-subtitle and remaining integrated acceptance checks.
