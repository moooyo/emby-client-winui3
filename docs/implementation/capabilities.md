...
| Automated checks | Unified Release run: **340 passed** across API 47, media transport 73, Windows platform 88, and playback 132. | Most HTTP/engine checks use test adapters; these are not a broad decoder or server certification. |
