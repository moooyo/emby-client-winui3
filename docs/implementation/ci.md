...
The latest audited Windows source is `619b1660aeac59b3fcc662c056534f69d97d6fe2`. [Run 34418817999 / job 102689550398](https://github.com/moooyo/emby-client-winui3/actions/runs/34418817999/job/102689550398) completed successfully at 2026-09-09 23:56:19 UTC: **449 tests** (47 API, 125 media transport, 141 platform, 136 playback), Release build, Native AOT, unsigned-package verification, and uploads. The [retained receipt](verification/windows-ci-619b166.json) records zero failures/skips and the existing generated WinUIEx CS0618 warning. The source includes the optional session-triggered observation hook; the default CI application excludes observation instrumentation. No desktop, allocation-root-cause, decoder, or installed-runtime result is supplied by this CI run.

The earlier [startup-repair run at bc3d290](https://github.com/moooyo/emby-client-winui3/actions/runs/34406313675) also passed the same 449-test population and retains its [separate receipt](verification/windows-ci-bc3d290.json).
