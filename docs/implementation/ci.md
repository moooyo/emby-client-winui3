...
The latest audited Windows source is `b5d9c2baf5dcc57e7d5c5d9e7f629546e60d7dbd`. [Run 34404127109 / job 102642877931](https://github.com/moooyo/emby-client-winui3/actions/runs/34404127109/job/102642877931) completed successfully at 2026-09-09 21:00:29 UTC with all 16 steps: 440 tests, Release build, Native AOT, SBOM, unsigned-package verification, and uploads. The [retained receipt](verification/windows-ci-b5d9c2b.json) records the exact head, zero failed/skipped tests, and package hash. The 40 local fixture-boundary harness checks remain a separate population and are not included in 440. No desktop, decoder, or installed-runtime result is supplied by this CI run.
