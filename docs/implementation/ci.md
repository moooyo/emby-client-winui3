...
The latest audited Windows source is `532f683a3df68a6b5d0da62e34f277a2b1807a15`. [Run 34397362185 / job 102620258748](https://github.com/moooyo/emby-client-winui3/actions/runs/34397362185/job/102620258748) completed successfully at 2026-09-09 19:53:05 UTC with 440 tests and the Windows build/AOT/unsigned-package steps. The [retained metadata](verification/ui-779b-20260910/windows-ci-532f683.json) identifies that exact head. Its separate [local code receipt](verification/code-batch-20260910.json) and [normal-app desktop receipt](verification/ui-779b-20260910/summary.json) have their own scopes; the desktop memory gate remains unresolved.
